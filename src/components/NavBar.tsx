...
export function NavBar(){
    ...
    return (
        ...
        <h1 className='w-full text-3xl font-bold text-green-500'>CreateSolutionsWolrd.</h1>
        <ul className='hidden md:flex '>
            ...
            <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-black ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
                <h1 className='w-full text-3xl font-bold text-green-500 m-4'>CrateSolutionsWolrd.</h1>
